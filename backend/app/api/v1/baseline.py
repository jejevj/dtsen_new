...
# Filter: hanya kembalikan anggota jika NKK-nya memiliki desil_nasional 1-4
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# _build_anggota_db_query
# JOIN ke ZawaKeluarga untuk memfilter desil_nasional IN (1,2,3,4)
# ---------------------------------------------------------------------------
