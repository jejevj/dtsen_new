      ...
      <div class="dash-content">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm px-5 py-4">
          <div class="flex flex-wrap items-end gap-4">
            <div class="flex flex-col gap-1 flex-[3]" v-if="paramLembaga.length > 1">
              ...
              <Select v-model="selectedLembaga" :options="paramLembaga" optionLabel="nama" optionValue="kode" placeholder="Semua" class="w-full text-sm" filter show-clear />
            </div>
            <div class="flex flex-col gap-1 flex-1">
              <label class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Tahun</label>
              <Select v-model="selectedYear" :options="paramTahun" optionLabel="tahun" optionValue="tahun" placeholder="Pilih" class="w-full text-sm" filter show-clear />
            </div>
            <div class="flex flex-col gap-1 flex-[3]">
              ...
              <Select v-model="selectedProvinsi" :options="paramProv" :loading="wilayahLoading" option-label="nama" option-value="kode" placeholder="Semua Provinsi" class="w-full text-sm" filter show-clear @change="optKabupaten" />
            </div>
            <div class="flex flex-col gap-1 flex-[3]">
              <label class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Kabupaten / Kota</label>
              <Select v-model="selectedKabupaten" :options="paramKab" :loading="wilayahLoading" option-label="nama" option-value="kode" placeholder="Semua" class="w-full text-sm" filter show-clear @change="optKecamatan" />
            </div>
            <div class="flex flex-col gap-1 flex-[3]">
              <label class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Kacamatan</label>
              <Select v-model="selectedKecamatan" :options="paramKec" :loading="wilayahLoading" option-label="nama" option-value="kode" placeholder="Semua" class="w-full text-sm" filter show-clear />
            </div>
            <div class="flex items-end gap-2">
              <Button label="Tampilkan" icon="pi pi-search" size="small" @click="loadData" />
              <Button label="Reset" icon="pi pi-times" size="small" severity="secondary" outlined @click="resetOption" />
            </div>
          </div>
        </div>
        ...
        <div class="hero-grid" style="display:grid;gap:16px;">
          ...
          <div class="detail-card wm-wrap" style="display:flex;flex-direction:column;padding-left:0;padding-right:0;padding-bottom:0;">
            <div class="wm-overlay" aria-hidden="true">
              <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="wm-base-wilayah" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
          ...
          <div class="detail-card wm-wrap" style="display:flex;flex-direction:column;padding-left:0;padding-right:0;padding-bottom:0;">
            <div class="wm-overlay" aria-hidden="true">
              <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="wm-base-desil" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                    <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                    <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                  </pattern>
                </defs>
        ...
        <div class="detail-card wm-wrap" style="display:flex;flex-direction:column;padding-left:0;padding-right:0;padding-bottom:0;">
          <div class="wm-overlay" aria-hidden="true">
            <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="wm-dist-wilayah" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                  <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                  <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                </pattern>
              </defs>
        ...
        <div class="detail-card wm-wrap" style="display:flex;flex-direction:column;padding-left:0;padding-right:0;padding-bottom:0;">
          <div class="wm-overlay" aria-hidden="true">
            <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="wm-dist-desil" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                  <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                  <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                </pattern>
              </defs>
        ...
        <div style="display:grid;grid-template-columns:1fr 2fr;gap:16px;" class="chart-row">
          <div class="card-box wm-wrap" style="background:white;">
            <div class="wm-overlay" aria-hidden="true">
              <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="wm-chart-gender" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                    <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                    <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                  </pattern>
                </defs>
          ...
          <div class="card-box wm-wrap" style="background:white;">
            <div class="wm-overlay" aria-hidden="true">
              <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="wm-chart-desil" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                    <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                    <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                  </pattern>
                </defs>
        ...
        <div class="detail-card wm-wrap" style="display:flex;flex-direction:column;padding-left:0;padding-right:0;">
          <div class="wm-overlay" aria-hidden="true">
            <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="wm-usia" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                  <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                  <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                </pattern>
              </defs>
        ...
        <div class="grid-3" style="display:grid;gap:16px;">
          ...
          >
            <div class="wm-overlay" aria-hidden="true">
              <svg class="wm-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern :id="'wm-bidang-'+i" x="0" y="0" width="320" height="120" patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
                    <text x="10" y="40" font-family="Inter, sans-serif" font-size="14" font-weight="700" letter-spacing="2" fill="rgba(15,23,42,0.09)">DO NOT COPY</text>
                    <text x="10" y="70" font-family="Inter, sans-serif" font-size="13" font-weight="600" letter-spacing="1" fill="rgba(15,23,42,0.07)">{{ userIdentifier }}</text>
                  </pattern>
                </defs>
...
const genderDataM = computed(() => wilayahData.value.reduce((t,i)=>t+Number(i.mustahik_m||0),0))
...
const roleBadgeStyle = computed(() => {
  ...
  const map = { admin:{background:'#fef9c3',color:'#b45309'}, operator:{background:'#dcfce7',color:'#15803d'}, analis:{background:'#dbeafe',color:'#1d4ed8'} }
  return map[role] || map.operator
})

const pieOpts = { plugins:{ legend:{ display:false } }, responsive:true, maintainAspectRatio:false }
const barOpts = { plugins:{ legend:{ display:false } }, responsive:true, maintainAspectRatio:false, scales:{ y:{ beginAtZero:true, ticks:{ precision:0 } } } }
...
onMounted(() => {
  ...
  ro = new ResizeObserver((entries) => {
    ...
    if (w !== prevWidth) { prevWidth = w; setTimeout(()=>{ chartKey.value++ }, 320) }
  })
...
:deep(.p-datatable .p-datatable-thead > tr > th) { justify-content: center !important; }
